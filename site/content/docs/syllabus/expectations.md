...
Again, all work is required to be your original creation. By defualt, your individual assignments are to be created and written by you (no use of AI/LLMs allowed). For your group project, you are allowed to use AI-- but you are *strongly* encouraged not to blindly generate code. Instead, if you choose to use it, it should be to help you understand more advanced concepts; used as a reference so that you can augment your own code rather than leaning on it as a crutch.

{{% hint danger %}}

If ANY of your individual (i.e., non-group-project) work is found to be copied (from online sources OR ChatGPT/ AI), you would be subject to serious penalties which could be one or more of the following:
